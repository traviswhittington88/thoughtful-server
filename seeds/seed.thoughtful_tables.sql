...
INSERT INTO thoughtful_users (user_name, full_name, pseudonym, password)
  VALUES
    ...
    ('theBugs52', 'Bugs Bunny', 'Bugs', '$2a$10$vjtEfvmQIOnY0/aop1ESTeBVoIlEZswDL9IUd6ywxurTqM7bp5oXK'), 
...
INSERT INTO thoughtful_entries (title, content, pseudonym, journal_id, user_id)
  VALUES 
    ...
    ('Ah...what''s up doc?', 'Wow what a day! I managed to escape that dopey hunter Fudd, Yosemite GoofHead, and some other notoriously dumb antagonists! not to mention.. I got to eat several delicious carrots.','Bugs Bunny',4, 5),
