...
INSERT INTO thoughtful_entries (title, content, pseudonym, journal_id)
  VALUES 
    ('My first journal entry', 'I don''t know what to say!','Sam wonder', 1),
    ('You talkin to me?', 'You must be talkin to me cuz I''m the only one around..','Travis Bickle', 6),
    ('Where are they!', 'Seriously, it''s hurting me to talk in this voice','Batman', 5),
    ('Fatman', 'If you''re good at something, never do it for free.','Joker', 7),
    ...
    ('Today was a bad day', 'Well where to begin? I blew myself up wit my own musket chasing dat twicky cawot eat''n, no good scwewy wabbit... guess I''ll twy again next week','Elmer Fudd', 2),
